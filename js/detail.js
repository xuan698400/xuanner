...
ArticleDetail.prototype = {
    ...
    init: function (callback) {
        ...
        this.article.loadData(function () {
            ...
            _this.id = BW.getParamFromUrl('id', '');
            var articleDetail = _this.article.getById(_this.id);
            _this.title = articleDetail.title;
            _this.tagsStr = articleDetail.tags;
            _this.createTime = articleDetail.createTime;
    ...
    render: function () {
        ...
        $('.article-detail-info-tags').html(_this.article.buildTagsHtml(_this.tagsStr));
        //
